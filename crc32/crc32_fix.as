...
0000000000400440 <_start>:
  ...
  40045d:	48 c7 c7 35 06 40 00 	mov    $0x400635,%rdi
...
000000000040059e <CRC32>:
  ...
  4005e0:	eb 2f                	jmp    400611 <CRC32+0x73>
  4005e2:	8b 45 f8             	mov    -0x8(%rbp),%eax
  4005e5:	89 c2                	mov    %eax,%edx
  4005e7:	8b 4d fc             	mov    -0x4(%rbp),%ecx
  4005ea:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
  4005ee:	48 01 c8             	add    %rcx,%rax
  4005f1:	0f b6 00             	movzbl (%rax),%eax
  /*该条指令前没有了movsbl %al,%eax指令，此时不会做有符号扩展*/
  4005f4:	31 d0                	xor    %edx,%eax
  4005f6:	0f b6 c0             	movzbl %al,%eax
  4005f9:	48 98                	cltq  
  /*此处的访问不会越界或访问到脏数据*/
  4005fb:	8b 04 85 80 10 60 00 	mov    0x601080(,%rax,4),%eax
  400602:	8b 55 f8             	mov    -0x8(%rbp),%edx
  400605:	c1 ea 08             	shr    $0x8,%edx
  400608:	31 d0                	xor    %edx,%eax
  40060a:	89 45 f8             	mov    %eax,-0x8(%rbp)
  40060d:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
  400611:	8b 45 fc             	mov    -0x4(%rbp),%eax
  400614:	3b 45 e4             	cmp    -0x1c(%rbp),%eax
  400617:	72 c9                	jb     4005e2 <CRC32+0x44>
  400619:	f7 55 f8             	notl   -0x8(%rbp)
  40061c:	8b 45 f8             	mov    -0x8(%rbp),%eax
  40061f:	89 c6                	mov    %eax,%esi
  400621:	bf 10 07 40 00       	mov    $0x400710,%edi
  400626:	b8 00 00 00 00       	mov    $0x0,%eax
  40062b:	e8 e0 fd ff ff       	callq  400410 <printf@plt>
  400630:	8b 45 f4             	mov    -0xc(%rbp),%eax
  400633:	c9                   	leaveq 
  400634:	c3                   	retq   
...
0000000000400635 <main>:
  ...
  400639:	48 83 ec 20          	sub    $0x20,%rsp
  40063d:	89 7d ec             	mov    %edi,-0x14(%rbp)
  400640:	48 89 75 e0          	mov    %rsi,-0x20(%rbp)
  400644:	c6 45 f0 31          	movb   $0x31,-0x10(%rbp)
  400648:	c6 45 f1 32          	movb   $0x32,-0xf(%rbp)
  40064c:	c6 45 f2 33          	movb   $0x33,-0xe(%rbp)
  400650:	c6 45 f3 e4          	movb   $0xe4,-0xd(%rbp)
  400654:	c6 45 f4 b8          	movb   $0xb8,-0xc(%rbp)
  400658:	c6 45 f5 9c          	movb   $0x9c,-0xb(%rbp)
  40065c:	c6 45 f6 31          	movb   $0x31,-0xa(%rbp)
  400660:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
  400667:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
  40066b:	be 07 00 00 00       	mov    $0x7,%esi
  400670:	48 89 c7             	mov    %rax,%rdi
  400673:	e8 26 ff ff ff       	callq  40059e <CRC32>
  400678:	c9                   	leaveq 
  400679:	c3                   	retq   
